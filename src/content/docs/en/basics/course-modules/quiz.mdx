...
A course module is an activity module that has been linked to a specific course. When you link a quiz module to a course:
...
- Students can create quiz attempts tied to that specific course module
- Instructors can view and manage all quiz attempts within the course context
