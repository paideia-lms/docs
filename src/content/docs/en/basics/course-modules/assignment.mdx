...
A course module is an activity module that has been linked to a specific course. When you link an assignment module to a course:
...
- Students can create submissions tied to that specific course module
- Instructors can view and manage all submissions within the course context
